...
@IBDesignable open class MGMarqueeLabel: UILabel, CAAnimationDelegate {
    ...
    private func setup() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(MGMarqueeLabel.restartLabel), name: NSNotification.Name.UIApplicationDidBecomeActive, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(MGMarqueeLabel.shutdownLabel), name: NSNotification.Name.UIApplicationDidEnterBackground, object: nil)
    }
