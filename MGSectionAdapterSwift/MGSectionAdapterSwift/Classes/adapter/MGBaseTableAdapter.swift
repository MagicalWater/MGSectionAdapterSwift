...
open class MGBaseTableAdapter: MGBaseScrollAdapter, MGBaseTableDataBindDelegate, MGBaseTableCustomHeightDelegate {
    ...
    open func customSectionCellHeight(_ indexPath: IndexPath, section: MGSection) -> CGFloat? {
        return nil
    }
    
    //是否自定義最外層頂部cell的高度
    open func customOuterHeaderCellHeight(_ indexPath: IndexPath) -> CGFloat? {
        return nil
    }
    
    //是否自定義最外層底下cell的高度
    open func customOuterFooterCellHeight(_ indexPath: IndexPath) -> CGFloat? {
        return nil
    }
    
    //是否自定義section header的高度
    open func customSectionHeaderHeight(_ section: Int, header: MGSectionGroup.MGSectionHeader) -> CGFloat? {
        return nil
    }
    
    //是否自定義section footer的高度
    open func customSectionFooterHeight(_ section: Int, footer: MGSectionGroup.MGSectionFooter) -> CGFloat? {
        return nil
    }
...
extension MGBaseTableAdapter: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        ...
        if let header = sectionGroup.positionsHeaderCache[section]{
            return customSectionHeaderHeight(section, header: header) ?? UITableView.automaticDimension
        } else {
            return 0.01
        }
    }
    ...
    public func tableView(_ tableView: UITableView, heightForFooterInSection section: Int) -> CGFloat {
        ...
        if let footer = sectionGroup.positionsFooterCache[section] {
            return customSectionFooterHeight(section, footer: footer) ?? UITableView.automaticDimension
        } else {
            return 0.01
        }
    }
...
extension MGBaseTableAdapter : MGSectionDelegate {
    ...
    public func refreshSection(_ pos: MGSectionPos) {
        ...
        if let find = section { tableView.reloadRows(at: [find.absolatePos], with: UITableView.RowAnimation.automatic) }
    }
